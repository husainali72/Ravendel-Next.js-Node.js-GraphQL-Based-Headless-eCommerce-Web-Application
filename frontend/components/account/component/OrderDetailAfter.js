                        ...
                        <div className="col-md-6">
                            <div className="details">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <th>Subtotal</th>
                                        <td>{currency} {Data?.cartTotal ? getPrice(Data.cartTotal, currencyOptions) : getPrice(Data?.grandTotal, currencyOptions)}</td>
                                    </tr>
                                    {Data.couponCode && <tr>
                                        <th>Coupon <span className="coupon-applied">({Data.couponCode})</span></th>
                                        <td>- {currency} {Data?.discountAmount && getPrice(Data.discountAmount, currencyOptions)}</td>
                                    </tr>}
                                    <tr>
                                        <th>Grandtotal</th>
                                        <td>{currency} {Data?.grandTotal && getPrice(Data?.grandTotal, currencyOptions)}</td>
                                    </tr>
                                    <tr>
                        ...
                        <div className="details">
                            ...
                            <table className="product-detail">
                                ...
                                <tbody >
                                    {Data?.products?.map((order, i) =>
                                        <tr key={i}>
                                            ...
                                            <td>{currency} {order ? getPrice(order?.productPrice, currencyOptions) : null}</td>
                                        </tr>
                                    )}
                                </tbody>
                                <tr>
                                    <th colSpan={2} style={{ textAlign: 'right' }} >Subtotal</th>
                                    <td>{currency} {getPrice(Data.cartTotal, currencyOptions)}</td>
                                </tr>

                                <tr>
                                    <th colSpan={2} style={{ textAlign: 'right' }}>Tax</th>
                                    <td>{currency} {Data.taxAmount ? getPrice(Data.taxAmount, currencyOptions) : "00"}</td>
                                </tr>
                                <tr>
                                    <th colSpan={2} style={{ textAlign: 'right' }}>Shipping</th>
                                    <td>{currency} {Data.shippingAmount ? getPrice(Data.shippingAmount, currencyOptions) : "20"}</td>
                                </tr>
                                {Data.couponCode && <tr>
                                ...
                                <tr className="total">
                                    ...
                                    <td>{currency} {Data ? getPrice(Data?.grandTotal, currencyOptions) : getPrice(Data?.cartTotal, currencyOptions)}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
