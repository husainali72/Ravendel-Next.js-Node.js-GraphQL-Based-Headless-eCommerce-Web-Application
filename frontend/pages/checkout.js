...
import { formatNumber, mutation, query, stripeCheckout ,currencySetter} from "../utills/helpers";
        ...
        const getProducts = async () => {
            ...
            if (session?.status === "authenticated" || userSession  !== null) {
                setIsLogin(true)
                    ...
                    const { grandTotal, cartTotal, totalShipping, totalTax } = get(carts, 'totalSummary');
