  ...
  return (
    <div className='support-page-wrapper'>
      <div className='container'>
        ...
        <p>Zemjet uses the collected data for various purposes:</p>
        <ul>
        ...
        <h2>4. Cookies</h2>
        <p>Zemjet uses cookies to enhance your experience on our website. Cookies are small data files stored on your device. You can choose to accept or decline cookies, but this may prevent you from taking full advantage of the website.</p>
        <h2>5. Security </h2>
        ...
        <p>Zemjet may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page. You are advised to review this Privacy Policy periodically for any changes.</p>
        <h2>8. Contact Us</h2>
