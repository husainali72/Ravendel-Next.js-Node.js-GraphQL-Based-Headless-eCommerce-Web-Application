  ...
  return (
    <div className='support-page-wrapper'>
      <div className='container'>
        ...
        <h2>Welcome to Zemjet</h2>
        <p>These Terms and Conditions outline the rules and regulations for using Zemjet's website, <a href='http://www.zemjet.com'>www.zemjet.com</a>.</p>
        <p>By accessing this website, we assume you accept these terms and conditions. Do not continue to use Zemjet if you do not agree to take all of the terms and conditions stated on this page</p>
        ...
        <p>Unless otherwise stated, Zemjet and/or its licensors own the intellectual property rights for all material on Zemjet. All intellectual property rights are reserved. You may access this from Zemjet for your own personal use, subject to restrictions set in these terms and conditions.</p>
        <h3>You must not:</h3>
        <ul>
          <li>Republish material from Zemjet</li>
          <li>Sell, rent, or sub-license material from Zemjet</li>
          <li>Reproduce, duplicate, or copy material from Zemjet</li>
          <li>Redistribute content from Zemjet</li>
        </ul>
        ...
        <ul>
          ...
          <li>Zemjet reserves the right to refuse service, terminate accounts, remove or edit content, or cancel orders at our discretion.</li>
        </ul>
        ...
        <ul>
          ...
          <li>Zemjet is not responsible for delays caused by shipping carriers or events beyond our control.</li>
          <li>Risk of loss and title for products purchased from Zemjet pass to you upon delivery to the carrier.</li>
        </ul>
        ...
        <ul>
          <li>Zemjet will not be liable for any damages arising from the use or inability to use our website or services.</li>
          <li>Zemjet does not warrant that the website will be uninterrupted or error-free.</li>
        </ul>
        ...
        <p>Zemjet reserves the right to revise these terms and conditions at any time. By using this website, you agree to be bound by the current version of these terms and conditions.</p>
        <h2>10. Contact Us</h2>
